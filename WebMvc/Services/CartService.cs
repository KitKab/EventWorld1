...
namespace WebMvc.Services
{
    public class CartService : ICartService
    {
        ...
        {
            //needs to know the user
            //identify the cart where it is located if you have one, 
            ...
            if (cart == null)
            {
                ...
                {
                    BuyerId = user.Id,
                    //create empty list pf cart item
            ...
            var basketItem = cart.Items
                ...
                .FirstOrDefault();
            if (basketItem == null)
            { // if new product added first time
        ...
        public Order MapCartToOrder(Cart cart)
        {
            var order = new Order();
            order.OrderTotal = 0;
            //for each item in your cart, start adding order item
